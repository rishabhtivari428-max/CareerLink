...
const Navbar = () => {
    ...
    return (
        <div className='bg-blue-700'>
            <nav className='flex justify-between p-6 text-white font-bold items-center'>
                <Link to='/'>
                    CareerLink
                </Link>
                ...
                <div className='flex gap-4 items-center'>
                    ...
                    {user?.role === 'Applicant' && (
                        <>
                            <Link to='/myapp' className='hover:underline'>My Applications</Link>
                    ...
                    {user?.role === 'Recruiter' && (
                        <>
                            <Link to='/recruiter' className='hover:underline'>Recruiter Page</Link>
                            <button onClick={handleLogout} className='bg-red-500 hover:bg-red-600 text-white font-semibold px-4 py-1.5 rounded-full cursor-pointer transition-colors'>Logout</button>
                        </>
                    )}
                </div>
